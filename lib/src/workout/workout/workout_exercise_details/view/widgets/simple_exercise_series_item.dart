...
class SimpleExerciseSeriesItem extends StatelessWidget {
  const SimpleExerciseSeriesItem({
    super.key,
      ...
      builder: (context) {
        return SeriesEditDialog(
          ...
          onConfirm: (int reps, double weight, int rest) {
            ...
            bloc.add(WorkoutExerciseDetailsAllSeriesChanged(series: newSeries));
          },
        );
      },
    );
